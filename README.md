...
[![DOWNLOAD](https://img.shields.io/badge/Size-896MB-red.svg?style=flat-square)](https://github.com/lib-hfut/lib-hfut/archive/master.zip)
[![CONTACTUS](
...
<p align="right">- 引自 [QSCTech/zju-icicles](https://github.com/QSCTech/zju-icicles) </p>

## Usage

使用方法：

- 在本仓库中找到你要下载的文件或文件夹, 复制网页URL到 [DownGit](https://minhaskamal.github.io/DownGit/#/home) 点击`CreateDownload Link`生成下载链接复制到下载工具或者点击`Download`直接下载。
...
>**特别注意!!**
>
>**机器人课很多平时很忙, 没有时间协助上传者整理资源。如果因以下几类错误而导致上传的资源质量不佳, 或令机器人需要花时间改写改资源, 机器人将会主动拒绝PR请求, 资源将会无法合并到仓库中。**
>
>**上传规则:**
>>GitHub平台上传规则为 `单个上传文件小于25MB(网页端)`, `单个上传文件小于100MB(Git)` 和 `单次上传文件总数小于100个` 。若要上传大于25MB的材料可以压缩后发送至邮箱 `libbot@protonmail.com` 由@libbot-hfut代为上传。
>
>**命名规则:**
>>**文件命名:**
>>
...
>>**文件夹/目录命名:**
>>
>>>根目录命名 `[标准课程名称]` , 根目录下级子目录命名 `[课程名称+资源类型+(教师姓名)]` 的命名规则进行归档。参考书籍/参考答案请直接放在根目录中, 不需要进行分类。
>
>**课程结构示意图**
>
