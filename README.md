...
[![CONTRIBUTORS](https://img.shields.io/badge/Contributor-5-1cc.svg?style=flat-square)](https://github.com/lib-hfut/lib-hfut/graphs/contributors)
[![DOWNLOAD](https://img.shields.io/badge/Size-1.33GB-%23FF4D5B.svg?style=flat-square)](https://github.com/lib-hfut/lib-hfut/archive/master.zip)
[![CONTACTUS](
...
- **上传规则:**
GitHub平台上传规则为 `单个上传文件小于25MB(网页端)` 和 `单次上传文件总数小于100个` 。若要上传大于25MB的材料可以压缩后发送至邮箱 `libbot@protonmail.com` 由@libbot-hfut代为上传。
