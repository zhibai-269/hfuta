...
DataAps = Pd.read_csv(r"d:\resource\airports.csv", header=None, dtype=str)

DataAps.columns = ["id", "name", "city", "country", "code", "icao", "latitude", "longitude", "altitude", "offset", "dst", "timezone","Na","Na"]
DataAps.to_csv(r"d:\resource\A.csv")
DataAps.to_excel(r"D:\resource\A.xls")
...
#
Mymap.readshapefile(r'D:\resource\CHN_adm_shp/CHN_adm1', 'states', drawbounds=True)
