...
通常来说, 仓库内的答案能够保证该课程成绩95+. 虽然Greasyfork上有脚本可以自动搜题做题, 但是由于题目不全, 答案有误等问题(尤其是新开的课), 若想拿高分建议手工做题.
...
超星尔雅是线上考试. 内容是考平时的测试题目, 建议考试前建立一个平时题目的文档, 考试时直接Ctrl+F查找. (超星考试答题时间越短, 分越高)

智慧树的考试是在学校机房考. 机考闭卷. 考试内容大部分为平时内容.
